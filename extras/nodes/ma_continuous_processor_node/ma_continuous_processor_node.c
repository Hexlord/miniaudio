...
static void ma_continuous_processor_node_process_pcm_frames(ma_node *pNode,
  ...
  pContinuousProcessorNode->callback(ppFramesIn, ppFramesOut, ma_node_graph_get_time(ma_node_get_node_graph(pNode)), framesIn, pContinuousProcessorNode->userData);
}
